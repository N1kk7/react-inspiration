                ...
                <div className='subscriptionWrapper'>
                    <div className='currentCard'>
                        <div className='topCard'>
                            ...
                            <div className='cardBtn'>{addBilling ? <button>Subscription</button> : <button>Cancel membership</button>}</div>
                        </div>
                    ...
                    <div className='paymentMethod'>
                        <div className='topCard'>
                            ...
                            <div className='cardBtn'>{!addBilling && <button onClick={() => navigate('/my-subscription/billing')}>Add new method</button>}</div>
                        </div>
                            ...
                            {addBilling ? (
                                <div className='card'>
                                    <div className='cardDescription'>
                                        ...
                                        <div className='cardCurrency'>
                                            <h5>Master Card in {lastCardDigit}</h5>
                                            <span>UAN</span>
                                        </div>
                                    </div>
                                ...
                                <div className='noPayment'>
                                    ...
                                    <div className='description'>
                                        <span>Payment method is not set up</span>
                                    </div>
                                </div>
                            )}
                        </div>
