            ...
            <div className='modal getInfo'>
                <div className='modal-wrapper'>
                    ...
                    <div className='modalQuestion questionTop'>
                        <h5>Where did you learn about Adinspiration?</h5>
                    </div>
                    ...
                    <div className='modalQuestion listQuestion'>
                        <h5>What brings you to Adinspiration?</h5>
                    </div>
                    <div className='answerList'>
                        ...
                        >
                            <input type='checkbox' name='answer' id='answer-1' value={'answer1'} />
                            <label htmlFor='answer-1'>Discovering the latest trends and winning ad ideas</label>
                        </fieldset>
                        <fieldset
                            onClick={(event) => {
                        ...
                        >
                            <input type='checkbox' name='answer' id='answer-2' value={'answer2'} />
                            <label htmlFor='answer-2'>Finding UGC creators to hire</label>
                        </fieldset>
                        <fieldset
                            onClick={(event) => {
                        ...
                        >
                            <input type='checkbox' name='answer' id='answer-3' value={'answer3'} />
                            <label htmlFor='answer-3'>Sharing my own ad creatives</label>
                        </fieldset>
                    </div>
