        ...
        <>
            <div className="modal supportModal">
                ...
                <div className="modal-wrapper supportWrapper">
                    <div className="closeBtn" onClick={() => {dispatch(closeSupportModal())}}>
                    ...
                    <div className="typeRequest">
                        ...
                        <div className="inputWrapper">
                            <input type="select" placeholder={typeRequestPlaceholder} onClick={(event) => {event.stopPropagation(); dispatch(openTypeRequest())}}/>
                    ...
                    {typeRequestModal && <div className="typePopup">
                            <div className="requestTypeList">
                                <ul>
                                    <li onClick={() => {dispatch(closeTypeRequest('feature-request'))}}>
                                        <span>
                                            Feature request
                                        </span>
                                    </li>
                                    <li onClick={() => {dispatch(closeTypeRequest('bug-report'))}}>
                                        <span>
                                            Bug report
                                        </span>
                                    </li>
                                    <li onClick={() => {dispatch(closeTypeRequest('other'))}}>
                                        <span>
                                            Other
                                        </span>
                                    </li>
