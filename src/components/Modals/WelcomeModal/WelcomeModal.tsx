                            ...
                            <div className='companyType'>
                                <div className='companyTypeList'>
                                    <ul>
                                        <li
                                            onClick={() => {
                                                dispatch(setInputPlaceholder('Agency'));
                                            }}
                                        >
                                            <span>Agency</span>
                                        </li>
                                        <li
                                            onClick={() => {
                                                dispatch(setInputPlaceholder('Brand'));
                                            }}
                                        >
                                            <span>Brand</span>
                                        </li>
                                        <li
                                            onClick={() => {
                                                dispatch(setInputPlaceholder('Software Company'));
                                            }}
                                        >
                                        ...
                                        <li
                                            onClick={() => {
                                                dispatch(setInputPlaceholder('UGC Creator'));
                                            }}
                                        >
                                        ...
                                        <li
                                            onClick={() => {
                                                dispatch(setInputPlaceholder('Other'));
                                            }}
                                        >
                                            <span>Other</span>
                                        </li>
